...
for this paper: 414 theorems across 78 files, zero \texttt{sorry}, zero
\texttt{admit}, one axiom (A0$^*$, derived from $\noth$), compiled
against mathlib~v4.14.0.  Appendix~\ref{app:formalization} maps paper
claims to formal modules.
